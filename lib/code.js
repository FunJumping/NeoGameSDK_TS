    ...
    class ForgetPasswordView extends BlackCat.ViewBase {
        ...
        doGetCode() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                switch (accountType) {
                    case 'email':
                        res = yield BlackCat.ApiTool.getForgetCodeByEmail(this.inputUid.value, this.inputAccount.value, BlackCat.Main.langMgr.type);
                        break;
                    case 'phone':
...
var BlackCat;
(function (BlackCat) {
    class ModifyHeadImgView extends BlackCat.ViewBase {
        start() {
            super.start();
        }
        create() {
    ...
    BlackCat.ModifyHeadImgView = ModifyHeadImgView;
})(BlackCat || (BlackCat = {}));
var BlackCat;
(function (BlackCat) {
            ...
            switch (type) {
                ...
                case "ModifyHeadImgView":
                    ...
                    if (!this.modifyHeadImgView) {
                        this.modifyHeadImgView = new BlackCat.ModifyHeadImgView();
...
(function (BlackCat) {
    class ApiTool {
        ...
        static getForgetCodeByEmail(uid, email, lang) {
            return __awaiter(this, void 0, void 0, function* () {
