                    ...
                    BlackCat.ViewTransConfirmGas.callback = (params) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                            try {
                                ...
                                if (res.err == false) {
                                    params.sbPushString = "transfer";
                                    yield BlackCat.ApiTool.addUserWalletLogs(Main.user.info.uid, Main.user.info.token, res.info, Main.appid, params.count.toString(), "6", JSON.stringify(params), Main.netMgr.type);
                                    yield Main.viewMgr.payView.doGetWalletLists(1);
                                }
                            }
                            catch (e) {
...
(function (BlackCat) {
    class NetMgr {
        ...
        chang2test() {
            this.type = 2;
            BlackCat.tools.WWW.api = "https://api.nel.group/api/testnet";
            BlackCat.tools.WWW.apiaggr = "https://api.nel.group/api/testnet";
            BlackCat.tools.CoinTool.id_SGAS = "0x2761020e5e6dfcd8d37fdd50ff98fa0f93bccf54";
            BlackCat.Main.resHost = "http://182.254.139.130/sdk/";
        }
        change2Main() {
            this.type = 1;
