...
(function (BlackCat) {
    class NetMgr {
        ...
        _selectApi(callback) {
            ...
            var conn = new BlackCat.Connector(this.apis, "apic_test.php", 'api');
        ...
        _selectNode(callback, type, force) {
            BlackCat.Main.viewMgr.viewConnecting.showConnecting();
            BlackCat.Main.viewMgr.iconView.showState();
            var conn = new BlackCat.Connector(this.nodes[type], "?jsonrpc=2.0&id=1&method=getblockcount&params=[]", 'node');
            conn.getOne((res, response) => {
                if (res === false) {
        ...
        selectCli(callback, type, force = 0) {
            if (!this.clis || !this.clis[type] || this.clis[type].length == 0) {
                ...
                BlackCat.tools.WWW.api_cli = null;
                callback();
            ...
            if (force == 0 && this.cli_server && this.cli_server.hasOwnProperty(type) && this.cli_server[type]) {
                this.node_server[type] = this.node_change_tmp;
                BlackCat.tools.WWW.api = this.node_server[type];
                BlackCat.tools.WWW.api_cli = this.cli_server[type];
                callback();
                if (BlackCat.Main.viewMgr.viewConnecting.isCreated)
                    BlackCat.Main.viewMgr.viewConnecting.remove();
                BlackCat.Main.viewMgr.iconView.hiddenState();
        ...
        _selectCli(callback, type) {
            BlackCat.Main.viewMgr.viewConnecting.showConnecting();
            BlackCat.Main.viewMgr.iconView.showState();
            var conn = new BlackCat.Connector(this.clis[type], "?jsonrpc=2.0&id=1&method=getblockcount&params=[]&uid=" + BlackCat.Main.randNumber, 'cli');
            conn.getOne((res, response) => {
                if (res === false) {
        ...
        change2test(callback) {
            return __awaiter(this, void 0, void 0, function* () {
                this.selectNode(() => {
                    this.type = 2;
                    BlackCat.tools.CoinTool.id_SGAS = "0x961e628cc93d61bf636dc0443cf0548947a50dbe";
                    BlackCat.tools.CoinTool.id_SGAS_OLD = ["0x2761020e5e6dfcd8d37fdd50ff98fa0f93bccf54"];
                    callback();
                }, 2);
            });
        }
        ...
        create() {
            ...
            this.div.onclick = () => {
                ...
                if (BlackCat.Main.viewMgr.payView && BlackCat.Main.viewMgr.payView.isCreated) {
                    BlackCat.Main.viewMgr.payView.getHeight();
                }
            };
...
(function (BlackCat) {
    class PayExchangeDetailView extends BlackCat.ViewBase {
        create() {
            ...
            labelExchangePrice.textContent = BlackCat.Main.langMgr.get("pay_exchange_price");
            ...
            this.divAddress = this.objCreate("div");
            this.divAddress.classList.add("pc_receivables");
            this.divAddress.textContent = BlackCat.AddressbookDetailsView.contact.address_wallet;
            this.ObjAppend(divObj, this.divAddress);
            var divQRCode = this.objCreate("div");
            divQRCode.classList.add("pc_qrcode");
            this.ObjAppend(divObj, divQRCode);
            ...
            QrCodeWithLogo.toImage({
                image: qrObj,
                content: BlackCat.AddressbookDetailsView.contact.address_wallet
            }).then(() => {
                var url = URL.createObjectURL(this.base64ToBlob(qrObj.src));
                qr_download.setAttribute('href', url);
                qr_download.setAttribute("download", BlackCat.AddressbookDetailsView.contact.address_wallet + ".png");
            });
            this.ObjAppend(divQRCode, qrObj);
            var qr_download = this.objCreate("a");
            qr_download.classList.add("iconfont", "icon-xiazai");
            ...
            var divDescribeText = this.objCreate("div");
            divDescribeText.classList.add("pc_describetext");
            divDescribeText.textContent = BlackCat.AddressbookDetailsView.contact.address_desc ? BlackCat.AddressbookDetailsView.contact.address_desc : BlackCat.Main.langMgr.get("addressbook_det_empty");
            this.ObjAppend(divObj, divDescribeText);
        }
        toRefer() {
        ...
        doMakeTransfer() {
            return __awaiter(this, void 0, void 0, function* () {
                if (BlackCat.Main.isWalletOpen()) {
                    ...
                    BlackCat.PayTransferView.address = BlackCat.AddressbookDetailsView.contact.address_wallet;
                    BlackCat.Main.viewMgr.change("PayTransferView");
                }
                else {
                    BlackCat.ViewWalletOpen.callback = () => {
...
(function (BlackCat) {
    class PayExchangeView extends BlackCat.ViewBase {
        constructor() {
            super(...arguments);
            this.titlelist = ["NEO", "BTC", "ETH", "USDT"];
        }
        create() {
            this.div = this.objCreate("div");
            this.div.classList.add("pc_bj");
            ...
            divExchange.classList.add("pc_exchangetitle");
            this.ObjAppend(this.div, divExchange);
            this.ulExchange = this.objCreate("ul");
            this.ObjAppend(divExchange, this.ulExchange);
            this.titlelist.forEach(data => {
            ...
            var divExchangeName = this.objCreate("div");
            divExchangeName.classList.add("pc_exchangename");
            var imgExchangeName = this.objCreate("img");
            imgExchangeName.src = BlackCat.Main.resHost + "res/img/game0.png";
            ...
            btnExchange.textContent = BlackCat.Main.langMgr.get("pay_exchange_purchase");
            btnExchange.onclick = () => {
                this.hidden();
            ...
            var imgDetailName = this.objCreate("img");
            imgDetailName.src = BlackCat.Main.resHost + "res/img/game0.png";
            ...
            labelDetailPrice.textContent = BlackCat.Main.langMgr.get("pay_exchange_price");
            ...
            labelDetailRange.textContent = BlackCat.Main.langMgr.get("pay_exchange_range");
...
(function (BlackCat) {
    class PayView extends BlackCat.ViewBase {
        ...
        doMakeRefundOld() {
            return __awaiter(this, void 0, void 0, function* () {
                if (BlackCat.Main.isWalletOpen()) {
                    ...
                    BlackCat.ViewTransCount.transTypename1 = "OLD";
                    BlackCat.ViewTransCount.transTypename2 = "GAS";
                    BlackCat.ViewTransCount.transAmountsType = "GASCount";
        ...
        doMakeMintToken() {
            return __awaiter(this, void 0, void 0, function* () {
                if (BlackCat.Main.isWalletOpen()) {
                    BlackCat.ViewTransCount.transTypename1 = "GAS";
                    BlackCat.ViewTransCount.transTypename2 = "SGAS";
                    BlackCat.ViewTransCount.transAmountsType = "SGASCount";
                    BlackCat.ViewTransCount.refer = "PayView";
                    BlackCat.ViewTransCount.callback = () => {
                        if (BlackCat.ViewTransCount.transTypename2 == "SGAS") {
                            this.makeMintTokenTransaction();
                        }
                        else if (BlackCat.ViewTransCount.transTypename2 == "GAS") {
        ...
        doMakeRefund() {
            return __awaiter(this, void 0, void 0, function* () {
                if (BlackCat.Main.isWalletOpen()) {
                    BlackCat.ViewTransCount.transTypename1 = "SGAS";
                    BlackCat.ViewTransCount.transTypename2 = "GAS";
                    BlackCat.ViewTransCount.transAmountsType = "GASCount";
                    BlackCat.ViewTransCount.refer = "PayView";
                    BlackCat.ViewTransCount.callback = () => {
        ...
        getHeight() {
            return __awaiter(this, void 0, void 0, function* () {
                var height = yield BlackCat.tools.WWW.api_getCliHeight();
    ...
    class ViewTransCount extends BlackCat.ViewBase {
        start() {
            ...
            if (ViewTransCount.transTypename1 == "OLD") {
                ...
                this.divHaveGasAmounts.textContent = "GAS：" + BlackCat.Main.getStringNumber(BlackCat.Main.viewMgr.payView.gas);
            }
        }
        create() {
            this.div = this.objCreate("div");
            ...
            this.inputCount.placeholder = BlackCat.Main.langMgr.get("pay_transCount_input" + ViewTransCount.transAmountsType);
            ...
            this.divHaveSGasAmounts.textContent = "SGAS：" + BlackCat.Main.getStringNumber(BlackCat.Main.viewMgr.payView.sgas);
        ...
        dotransfertype() {
            if (ViewTransCount.transTypename1 == "GAS") {
                ...
                this.inputCount.placeholder = BlackCat.Main.langMgr.get("pay_transCount_inputGASCount");
            }
                ...
                this.inputCount.value = "";
                this.inputCount.placeholder = BlackCat.Main.langMgr.get("pay_transCount_inputSGASCount");
            }
        ...
        doGetBalances() {
            return __awaiter(this, void 0, void 0, function* () {
                setTimeout(() => {
                    this.divHaveSGasAmounts.innerHTML = "SGAS：" + BlackCat.Main.getStringNumber(BlackCat.Main.viewMgr.payView.sgas);
                    this.divHaveGasAmounts.innerHTML = "GAS：" + BlackCat.Main.getStringNumber(BlackCat.Main.viewMgr.payView.gas);
                    if (ViewTransCount.transTypename1 == "OLD") {
                        this.divHaveSGasAmounts.textContent = "SGAS(old)：" + ViewTransCount.transBalances;
                    }
