    ...
    class Main {
                ...
                if (Main.isWalletOpen()) {
                    ...
                    BlackCat.ViewTransConfirmGas.callback = (params) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            ...
                            if (res.err == false) {
                                yield BlackCat.ApiTool.addUserWalletLogs(Main.user.info.uid, Main.user.info.token, res.info, Main.appid, params.count.toString(), "6", '{"sbPushString":"transfer", "toaddr":"' + params.toaddress + '", "count": "' + params.count + '"}', Main.netMgr.type);
                                Main.viewMgr.payView.doGetWalletLists();
                            }
                        }
                        catch (e) {
        ...
        update() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.getAppNotifys();
                yield this.getPlatNotifys();
                ...
                if (r && r["script"]) {
                    ...
                    if (r) {
                        ...
                        if (r.txid) {
                            ...
                            var res = yield this.confirmPlatNotifyExt(params, r.txid);
        ...
        confirmPlatNotifyExt(params, ext) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        static showErrMsg(errMsg, callback = null, content_ext = null) {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.ViewAlert.content = errMsg;
                BlackCat.ViewAlert.content_ext = content_ext;
                BlackCat.ViewAlert.callback = callback;
                Main.viewMgr.change("ViewAlert");
            });
        }
        static showToast(msg, showTime = 2500) {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.ViewToast.content = msg;
                BlackCat.ViewToast.showTime = showTime;
                Main.viewMgr.change("ViewToast");
            });
        }
        static showInfo(msg, callback = null, content_ext = null) {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.ViewAlert.content = msg;
                BlackCat.ViewAlert.content_ext = content_ext;
                BlackCat.ViewAlert.callback = callback;
                Main.viewMgr.change("ViewAlert");
            });
        ...
        static showConFirm(msg) {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.ViewConfirm.content = msg;
                Main.viewMgr.change("ViewConfirm");
            });
        }
        static showLoading(msg) {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.ViewLoading.content = msg;
                Main.viewMgr.change("ViewLoading");
            });
        }
        static isWalletOpen() {
    ...
    class LangEN extends BlackCat.LangBase {
        constructor() {
            ...
            this.lang = {
                ...
                walletImport_doImport: "Binding wallet",
                ...
                errCode_100604: "This phone number has been registered!",
                ...
                errCode_100804: "This email address has been registered!",
...
(function (BlackCat) {
    class NetMgr {
        ...
        chang2test() {
            this.type = 2;
            BlackCat.tools.WWW.api = "http://47.52.159.178:82/api/testnet";
            BlackCat.tools.WWW.apiaggr = "http://47.52.159.178:82/api/testnet";
        }
        change2Main() {
            this.type = 1;
            BlackCat.tools.WWW.api = "https://api.nel.group/api/mainnet";
            BlackCat.tools.WWW.apiaggr = "https://api.nel.group/api/mainnet";
        }
        chang(type) {
            if (this.type != type) {
                ...
                switch (type) {
                    case 1:
                        this.change2Main();
                        BlackCat.Main.viewMgr.mainView.div.classList.remove("pc_windowtest2");
                        break;
                    case 2:
                        this.chang2test();
                        BlackCat.Main.viewMgr.mainView.div.classList.add("pc_windowtest2");
                        break;
                    default:
                        return false;
                }
...
(function (BlackCat) {
    class ForgetPasswordView extends BlackCat.ViewBase {
        create() {
            ...
            getCode.textContent = BlackCat.Main.langMgr.get("forgetpass_getCode");
            getCode.onclick = () => {
                this.doGetCode();
            };
            ...
            getCodecount.textContent = BlackCat.Main.langMgr.get("forgetpass_getCodecount");
            this.ObjAppend(codeInput, getCodecount);
            var doForgetPassword = this.objCreate("button");
            doForgetPassword.classList.add("pc_doLogin");
            doForgetPassword.textContent = BlackCat.Main.langMgr.get("forgetpass_doDirectLogin");
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                switch (accountType) {
                    case 'email':
                        ...
                        break;
                    case 'phone':
                        res = yield BlackCat.ApiTool.forgetPassByPhone(this.inputUid.value, this.getPhone(), this.inputCode.value, this.inputVpass.value);
                        break;
                    default:
                        return;
                }
        ...
        count_down() {
            ...
            var time = setInterval(() => {
                if (i > 0 && document.getElementById("pc_getPhoneCodecount") != null) {
                    i--;
                    document.getElementById("pc_getPhoneCodecount").innerText = BlackCat.Main.langMgr.get("forgetpass_getCodecountRetry") + "(" + i + ")";
                }
...
(function (BlackCat) {
    ...
    MainView.divMaskId = "BC_mask";
    BlackCat.MainView = MainView;
})(BlackCat || (BlackCat = {}));
var BlackCat;
(function (BlackCat) {
    class ModifyName extends BlackCat.ViewBase {
        start() {
            super.start();
        ...
        create() {
            ...
            this.inputCount.placeholder = BlackCat.Main.langMgr.get("modifyName_inpnt");
            ...
            popupClose.onclick = () => {
                BlackCat.Main.viewMgr.viewTransCount.div.classList.add("pc_fadeindown");
                this.remove(300);
            };
        ...
        toRefer() {
            if (BlackCat.ViewTransCount.refer) {
                BlackCat.Main.viewMgr.change(BlackCat.ViewTransCount.refer);
                BlackCat.ViewTransCount.refer = null;
            }
        }
        doConfirm() {
            ...
            BlackCat.ViewTransCount.callback = null;
        }
    }
    BlackCat.ModifyName = ModifyName;
})(BlackCat || (BlackCat = {}));
var BlackCat;
(function (BlackCat) {
    class MyInfoView extends BlackCat.ViewBase {
        create() {
            ...
            myinfo.innerHTML
                = '<ul>'
                    + '<li class="pc_myinfoimg">' + BlackCat.Main.langMgr.get("myinfo_headImg") + '<span><img src="' + this.getImg() + '"></span></li>'
                    + '<li>' + BlackCat.Main.langMgr.get("myinfo_nickname") + '<span onclick="modifyName()">' + this.getName() + '</span></li>'
                    + '<li>' + BlackCat.Main.langMgr.get("myinfo_sex") + '<span>' + this.getSex() + '</span></li>'
                    + '<li>' + BlackCat.Main.langMgr.get("myinfo_uid") + '<span>' + this.getUid() + '</span></li>'
                    + '<li>' + BlackCat.Main.langMgr.get("myinfo_area") + '<span>' + this.getArea() + '</span></li>'
                    + '</ul>';
        ...
        getSex() {
            return BlackCat.Main.langMgr.get("gender_" + BlackCat.Main.user.info.sex);
        }
        getArea() {
            return BlackCat.Main.langMgr.get("area_code_" + BlackCat.Main.user.info.area);
        }
        doLogout() {
            BlackCat.ViewConfirm.callback = () => {
                this.makeLogout();
        ...
        modifyName() {
            BlackCat.Main.viewMgr.change("ModifyName");
        }
    }
...
(function (BlackCat) {
    class PayReceivablesView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            textareaAddress.innerHTML = BlackCat.Main.user.info.wallet;
            ...
            popupClose.textContent = BlackCat.Main.langMgr.get("cancel");
            popupClose.onclick = () => {
                BlackCat.Main.viewMgr.payReceivablesView.div.classList.add("pc_fadeindown");
                this.remove(300);
            };
            this.ObjAppend(popupbutbox, popupClose);
            ...
            butreceivables.onclick = () => {
                var idcopy = document.getElementById("pc_receivables");
                idcopy.select();
...
(function (BlackCat) {
    class PayTransferView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            popupClose.textContent = BlackCat.Main.langMgr.get("cancel");
            popupClose.onclick = () => {
                BlackCat.Main.viewMgr.payTransferView.div.classList.add("pc_fadeindown");
                this.remove(300);
            };
            this.ObjAppend(popupbutbox, popupClose);
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (res) {
                    ...
                    if (res.err == false) {
                        ...
                        BlackCat.Main.showInfo(BlackCat.Main.langMgr.get("pay_transferDoSucc"));
                        this.remove();
...
(function (BlackCat) {
    class PayView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            payMyWallet.textContent = BlackCat.Main.user.info.name;
        ...
        doGetWalletLists(isFromTimeout = 0) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        getNetTypeName() {
            return BlackCat.Main.langMgr.get("nettype_" + BlackCat.Main.netMgr.type);
        }
        showChangeNetType() {
        ...
        getDivNetSelectType(type) {
            ...
            divObj.textContent = BlackCat.Main.langMgr.get("nettype_" + type);
            divObj.onclick = () => {
                if (BlackCat.Main.changeNetType(type)) {
                    BlackCat.Main.viewMgr.update();
                    BlackCat.Main.reset();
                }
            };
            return divObj;
...
(function (BlackCat) {
    class RegisterView extends BlackCat.ViewBase {
        create() {
            ...
            var getCode = this.objCreate("button");
            getCode.id = "pc_getPhoneCode";
            getCode.textContent = BlackCat.Main.langMgr.get("register_getCode");
            getCode.onclick = () => {
                this.doGetCode();
            };
            this.ObjAppend(codeInput, getCode);
            ...
            getCodecount.classList.add("pc_getPhoneCodecount");
            getCodecount.id = "pc_getPhoneCodecount";
            getCodecount.textContent = BlackCat.Main.langMgr.get("register_getCodecount");
            this.ObjAppend(codeInput, getCodecount);
            var doRegister = this.objCreate("button");
        ...
        count_down() {
            ...
            var time = setInterval(() => {
                if (i > 0 && document.getElementById("pc_getPhoneCodecount") != null) {
                    i--;
                    document.getElementById("pc_getPhoneCodecount").innerText = BlackCat.Main.langMgr.get("register_getCodecountRetry") + "(" + i + ")";
                }
                else if (document.getElementById("pc_getPhoneCodecount") != null) {
                    clearInterval(time);
                    document.getElementById("pc_getPhoneCodecount").style.display = "none";
...
(function (BlackCat) {
    class ViewAlert extends BlackCat.ViewBase {
        ...
        doConfirm() {
            BlackCat.Main.viewMgr.viewAlert.div.classList.add("pc_fadeindown");
            this.remove(300);
...
(function (BlackCat) {
    class ViewConfirm extends BlackCat.ViewBase {
        ...
        doConfirm() {
            BlackCat.Main.viewMgr.viewConfirm.div.classList.add("pc_fadeindown");
            this.remove(300);
        ...
        change(type) {
            switch (type) {
                ...
                case "ModifyName":
                    ...
                    if (!this.modifyName) {
                        this.modifyName = new BlackCat.ModifyName();
                        this.views[type] = this.modifyName;
                    }
                    this.modifyName.start();
                    break;
            }
        }
        removeAll() {
            for (let className in this.views) {
                ...
                switch (className) {
                    case "ViewConfirm":
                        if (BlackCat.Main.user.info.uid) {
                            v.remove();
                        }
                        break;
                    default:
...
(function (BlackCat) {
    class ViewWalletOpen extends BlackCat.ViewBase {
        ...
        create() {
            ...
            popupClose.textContent = BlackCat.Main.langMgr.get("cancel");
            popupClose.onclick = () => {
                BlackCat.Main.viewMgr.viewWalletOpen.div.classList.add("pc_fadeindown");
                this.remove(300);
    ...
    class WalletCreateView extends BlackCat.ViewBase {
        ...
        doCreate() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ThinNeo.Helper.GetNep2FromPrivateKey(key, this.inputPwd.value, this.wallet.scrypt.N, this.wallet.scrypt.r, this.wallet.scrypt.p, (info, result) => {
                        if (info == "finish") {
                            BlackCat.Main.viewMgr.viewLoading.remove();
...
(function (BlackCat) {
    class ApiTool {
        ...
        static forgetPassByPhone(uid, phone, code, new_pwd) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        static getForgetCodeByPhone(uid, phone) {
            return __awaiter(this, void 0, void 0, function* () {
...
(function (BlackCat) {
    ...
    (function (tools) {
        ...
        CoinTool.id_SGAS = "0x2761020e5e6dfcd8d37fdd50ff98fa0f93bccf54";
