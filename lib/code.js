        ...
        makeMintTokenTransaction() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    var makeTranRes = BlackCat.tools.CoinTool.makeTran(utxos_assets, nepAddress, BlackCat.tools.CoinTool.id_GAS, Neo.Fixed8.fromNumber(Number(mintCount)), Neo.Fixed8.fromNumber(Number(net_fee)));
                }
                catch (e) {
                    BlackCat.Main.viewMgr.viewLoading.remove();
                ...
                if (r) {
                    if (r["txid"] || r["sendrawtransactionresult"]) {
                        ...
                        var logRes = yield BlackCat.ApiTool.addUserWalletLogs(BlackCat.Main.user.info.uid, BlackCat.Main.user.info.token, r["txid"], "0", mintCount, "1", '{"sbParamJson":"[]", "sbPushString": "mintTokens", "nnc": "' + BlackCat.tools.CoinTool.id_SGAS + '", "netfee": "' + net_fee + '"}', BlackCat.Main.netMgr.type);
                        var height = yield BlackCat.tools.WWW.api_getHeight_nodes();
                        oldarr.map(old => old.height = height);
                        BlackCat.tools.OldUTXO.oldutxosPush(oldarr);
                        BlackCat.Main.viewMgr.viewLoading.remove();
...
(function (BlackCat) {
    class ViewTransCount extends BlackCat.ViewBase {
        ...
        create() {
            ...
            this.divSpeed = this.objCreate("div");
            ...
            if (this.inputcharge.value == "0") {
                ...
                this.divServiceCharge.textContent = BlackCat.Main.langMgr.get("pay_transCount_cost") + "0.00000001" + BlackCat.Main.langMgr.get("gas");
            }
        ...
        dofree() {
            ...
            this.net_fee = "0";
            this.divServiceCharge.textContent = BlackCat.Main.langMgr.get("pay_transCount_cost") + this.net_fee + " " + BlackCat.Main.langMgr.get("gas");
        ...
        dotransfertype() {
            if (this.selectTransfertype.value == "GAS") {
                ...
                this.divSpeed.style.display = "block";
            }
...
(function (BlackCat) {
    ...
    (function (tools) {
        class CoinTool {
            ...
            static makeTran(utxos, targetaddr, assetid, sendcount, net_fee = Neo.Fixed8.Zero) {
            ...
            static getSgasAssetsByAmount(id_SGAS = this.id_SGAS, amount) {
                return __awaiter(this, void 0, void 0, function* () {
                    var height = yield tools.WWW.api_getHeight_nodes();
                    var scriptHash = ThinNeo.Helper.GetAddressFromScriptHash(id_SGAS.hexToBytes().reverse());
                    var utxos = yield tools.WWW.api_getUTXOsToPay(scriptHash, tools.CoinTool.id_GAS, amount);
                    var olds = tools.OldUTXO.getOldutxos();
                    var olds2 = new Array();
                    for (let n = 0; n < olds.length; n++) {
                        const old = olds[n];
