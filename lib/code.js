...
(function (BlackCat) {
    ...
    class Main {
        ...
        static validateFormat(accountType, accountElement) {
            switch (accountType) {
                case "user":
...
(function (BlackCat) {
    class NetMgr {
        ...
        selectApi(callback) {
            ...
            var conn = new BlackCat.Connector(this.apis, "");
            conn.getOne((res) => {
                if (res === false) {
                    ...
                    BlackCat.Main.showErrMsg("netmgr_select_api_slow");
                    return;
                }
                console.log('[Bla Cat]', '[NetMgr]', 'api => ', res);
                BlackCat.ApiTool.base_url = res;
                this.api_server = res;
                callback();
            });
        }
        selectNode(callback, type) {
            ...
            conn.getOne((res) => {
                if (res === false) {
                    ...
                    BlackCat.Main.showErrMsg("netmgr_select_node_slow");
                    return;
                }
                console.log('[Bla Cat]', '[NetMgr]', 'node => ', res);
                BlackCat.tools.WWW.api = res;
...
var BlackCat;
(function (BlackCat) {
    class AddressbookAddView extends BlackCat.ViewBase {
        create() {
            ...
            butHeader.textContent = BlackCat.Main.langMgr.get("addressbook_add_button");
            butHeader.onclick = () => {
                this.butHeader();
            };
            ...
            labelName.textContent = BlackCat.Main.langMgr.get("addressbook_add_name");
            this.ObjAppend(divNameBox, labelName);
            this.inputName = this.objCreate("input");
            this.inputName.placeholder = BlackCat.Main.langMgr.get("addressbook_add_inputName");
            ...
            labelAddress.textContent = BlackCat.Main.langMgr.get("addressbook_add_address");
            this.ObjAppend(divAddressBox, labelAddress);
            this.textAddress = this.objCreate("textarea");
            this.textAddress.placeholder = BlackCat.Main.langMgr.get("addressbook_add_inputAddress");
            ...
            labelDescribe.textContent = BlackCat.Main.langMgr.get("addressbook_add_describe");
            this.ObjAppend(divDescribeBox, labelDescribe);
            this.textDescribe = this.objCreate("textarea");
            this.textDescribe.placeholder = BlackCat.Main.langMgr.get("addressbook_add_inputDescribe");
            this.ObjAppend(divDescribeBox, this.textDescribe);
        }
        toRefer() {
            if (AddressbookAddView.refer) {
                BlackCat.Main.viewMgr.change(AddressbookAddView.refer);
        ...
        butHeader() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!this.inputName.value) {
                    BlackCat.Main.showErrMsg("addressbook_add_inputName_err", () => {
                        this.inputName.focus();
                    });
                    return;
                }
                if (!this.textAddress.value) {
                    BlackCat.Main.showErrMsg("addressbook_add_inputAddress_err", () => {
                        this.textAddress.focus();
                    });
                    return;
                }
                if (!this.textDescribe.value) {
                    BlackCat.Main.showErrMsg("addressbook_add_inputDescribe_err", () => {
                ...
                if (res.r) {
                    this.return();
                    BlackCat.Main.showToast("addressbook_add_succ");
    ...
    BlackCat.AddressbookAddView = AddressbookAddView;
})(BlackCat || (BlackCat = {}));
var BlackCat;
(function (BlackCat) {
    class AddressbookDetailsView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            divDescribeText.textContent = BlackCat.Main.langMgr.get("addressbook_det_empty");
...
(function (BlackCat) {
    class AddressbookView extends BlackCat.ViewBase {
        create() {
            ...
            iHeader.onclick = () => {
                this.hidden();
                BlackCat.AddressbookAddView.refer = "AddressbookView";
                BlackCat.Main.viewMgr.change("AddressbookAddView");
            };
    ...
    class ForgetPasswordView extends BlackCat.ViewBase {
        ...
        validateAccount(emptySkip = true) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (BlackCat.Main.validateFormat(this.accountType, this.inputAccount) == false) {
                    return false;
                }
    ...
    class RegisterView extends BlackCat.ViewBase {
        ...
        validateUid(emptySkip = true) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (BlackCat.Main.validateFormat("user", this.inputUid) == false) {
                    return false;
                }
            ...
            switch (type) {
                ...
                case "AddressbookAddView":
                    ...
                    if (!this.addressbookAddView) {
                        this.addressbookAddView = new BlackCat.AddressbookAddView();
