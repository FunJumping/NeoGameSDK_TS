...
(function (BlackCat) {
    class NetMgr {
        ...
        chang2test() {
            this.type = 2;
            BlackCat.tools.WWW.api = "http://nelnode00.blacat.org:82/api/testnet";
            BlackCat.tools.WWW.apiaggr = "http://nelnode00.blacat.org:82/api/testnet";
            BlackCat.tools.CoinTool.id_SGAS = "0x2761020e5e6dfcd8d37fdd50ff98fa0f93bccf54";
        }
        change2Main() {
            this.type = 1;
            BlackCat.tools.WWW.api = "http://nelnode01.blacat.org:82/api/mainnet";
            BlackCat.tools.WWW.apiaggr = "http://nelnode01.blacat.org:82/api/mainnet";
...
(function (BlackCat) {
    class ModifySexView extends BlackCat.ViewBase {
        ...
        toRefer() {
            if (BlackCat.ModifyNameView.refer) {
                BlackCat.Main.viewMgr.change(BlackCat.ModifyNameView.refer);
                BlackCat.ModifyNameView.refer = null;
            }
        }
        doConfirm() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (var i = 0; i < sexInputObj.length; i++) {
                    if (sexInputObj[i].checked) {
                        ...
                        var res = yield BlackCat.ApiTool.modUserName(BlackCat.Main.user.info.uid, BlackCat.Main.user.info.token, sexValue);
                        if (res.r) {
...
(function (BlackCat) {
    class MyInfoView extends BlackCat.ViewBase {
        ...
        getSex() {
            return BlackCat.Main.langMgr.get("myinfo_" + BlackCat.Main.user.info.sex) ? BlackCat.Main.langMgr.get("myinfo_" + BlackCat.Main.user.info.sex) : BlackCat.Main.langMgr.get("myinfo_sex_0");
        }
        getArea() {
